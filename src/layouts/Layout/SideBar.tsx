        ...
        return (
            <div className="column sidebar-offcanvas" id="sidebar">
                <ul className="nav" id="menu">
                    ...
                    <li><Link to="upload"><i className="glyphicon glyphicon-cloud-upload"></i> <span>Upload</span></Link></li>
                    <li><Link to="edit"><i className="glyphicon glyphicon-edit"></i> <span>Édition</span></Link></li>
